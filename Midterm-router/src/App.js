...
class App extends Component {
  ...
  render() {
    ...
    const buttonNames = newbtn.map((styles, i) => (
      <Button key = {i} onClick = {this.styleFilter} buttonName = {styles} filterButtonActive={this.state.filterButtonActive === styles} />
    ))
    ...
    console.log(this.state.filterButtonActive);

    return (
      <Router>
        <div className="App">
          <input type = "text" placeholder = "Search" onChange = {this.onSearch}/>
          <i className="fas fa-filter" onClick = {this.filterButtonClicked}></i>

          <div className = {'filterMenuContainer ' + activeClass}>
            <div className = 'filterBox'>
              <span>By Popularity: </span>
                <Button onClick = {this.sortFirstName} buttonName = "Most Expensive" filterButtonActive={this.state.filterButtonActive === "Most Expensive"}/>
                <Button onClick = {this.sortLastName} buttonName = "Least Expensive" filterButtonActive={this.state.filterButtonActive === "Least Expensive"}/>
            </div>
            <div className='filterBox'>
              <span>By Style: </span>
                {buttonNames}
